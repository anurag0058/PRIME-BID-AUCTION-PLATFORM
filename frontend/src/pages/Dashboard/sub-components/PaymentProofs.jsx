...
export const Drawer = ({ setOpenDrawer, openDrawer }) => {
  ...
  return (
    <>
      {/* <section
        ...
        }  left-0 w-full transition-all duration-300 h-[90vh] bg-[#00000087] flex items-end max-h-[90vh] `}
      >
  ...
  className={`fixed ${
    openDrawer && singlePaymentProof.userId ? "bottom-0" : "-bottom-full"
  } left-0 w-full transition-all duration-300 h-[90vh] bg-[#00000087] flex items-end`}
>
  <div className="bg-white w-full max-h-[90vh] overflow-y-auto">
    <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
      ...
      <p className="text-stone-600">You can update payment status and amount.</p>
      <form className="flex flex-col gap-5 my-5">
        <div className="flex flex-col gap-3">
          <label className="text-[16px] text-stone-600">User ID</label>
          <input
